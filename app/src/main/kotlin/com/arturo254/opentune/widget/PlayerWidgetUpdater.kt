...
object PlayerWidgetUpdater {
    suspend fun update(
        ...
        runCatching {
            ...
            val glanceIds = manager.getGlanceIds(MusiqPlayerWidget::class.java)
            ...
            glanceIds.forEach { glanceId ->
                ...
                MusiqPlayerWidget().update(context, glanceId)
            }
        }.onFailure {
            Timber.tag("PlayerWidgetUpdater").w(it, "Unable to update Musiq player widget")
        }
    }
